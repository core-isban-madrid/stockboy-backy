...
var Encuesta = require('../models/encuesta.js')
var app = express();
...
app.get('/:id', function(req, res, next){
    ...
    Encuesta.findById(req.params.id,(err, encuestas)=>{
        if(err){ 
            return res.status(500).json({ 
                ok: false,
                mensaje: 'Error acceso Base de Datos',
...
app.post('/enviar', (req, res)=>{
    var body = req.body;
    let asunto = 'Encuesta de satisfacción';
    let texto = 'Para nosotros su opinión es lo más importante, por favor complete la escuesta de satisfacción';
                                ...
                                <td align="left">
                                  <table border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <div style="text-align: center;">
                                        <tr>
                                          <td> <a href="#" target="_blank">Acceder</a> </td>
                                        </tr>
                                      </div>
                                    </tbody>
                                  </table>
